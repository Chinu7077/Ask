 ...
 setTimeout(() => {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative min-h-screen flex flex-col items-center justify-between px-4 py-4 transition-colors duration-300",
    ...
    >
      ...
      {/* Footer */}
      <div className="flex flex-col items-center gap-2 text-xs text-muted-foreground mt-6 pb-2">
        {/* Social Icons */}
